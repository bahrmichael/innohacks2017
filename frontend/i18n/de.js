module.exports = {
    ...
    sadlyOutput: "Lass uns trotzdem fortfahren. ",
    gratulations: {
        wonderful: 'Wunderbar',
        nice: 'Super',
    ...
    noticedThat: "Ich habe es mir notiert, ",
    hmmNext: ". hmm, ... nächster Satz: ",
    headache: "Ich habe gerade Kopfschmerzen und habe deine letzte Antwort nicht verstanden. ",
    cancelSession: 'Du kannst mich nicht aufhalten, mua ah ha ha ha ha ha',
    stopSession: 'Wirklich? Mach einfach eine Pause und tüdeldü!',
    init: 'Fantastisch, weiter geht\'s! ',
    noLanguage: 'Es stehen keine Sprachen zur Auswahl',
    joinAnd: ', und ',
    between: 'zwischen',
    chooseLanguage: 'Welche Sprache willst du lernen: Du kannst wählen ',
    acceptedLanguage: 'Verstanden! Deine gewählte Sprache ist: ',
    proceedOnboarding: ' Lass uns mit dem onboarding Prozess weitermachen ',
    proceedSentence: ' Lass uns mit dem nächsten Satz weitermachen ',
